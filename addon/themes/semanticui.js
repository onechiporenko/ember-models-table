 ...
 */
export default class SemanticTheme extends DefaultTheme {
  ...
  @alias('footerSummaryNumericPagination') footerSummaryDefaultPagination;
  pageSizeWrapper = 'three wide tablet wide column';
  paginationWrapperNumeric = 'nine wide tablet wide column';
  @alias('paginationWrapperNumeric') paginationWrapperDefault;
