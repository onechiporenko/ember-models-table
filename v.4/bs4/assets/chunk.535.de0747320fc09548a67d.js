/*! For license information please see chunk.535.de0747320fc09548a67d.js.LICENSE.txt */
...
t.exports=function(e){return!!e&&("symbol"===o(e)||!!e.constructor&&"Symbol"===e.constructor.name&&"Symbol"===e[e.constructor.toStringTag])}})),Oe=M((function(e,t){"use strict"
var n=Se()
t.exports=function(e){if(!n(e))throw new TypeError(e+" is not a symbol")
return e}})),_e=M((function(e,t){"use strict"
...
return O(t,e),t},M._setScheduler=function(e){l=e},M._setAsap=function(e){u=e},M._asap=u,M.polyfill=function(){var e=void 0
if(void 0!==r)e=r
...
return d.reverse(),i=d.join(""),s=(1<<t-1)-1,l=parseInt(i.substring(0,1),2)?-1:1,u=parseInt(i.substring(1,1+t),2),c=parseInt(i.substring(1+t),2),u===(1<<t)-1?0!==c?NaN:l*(1/0):u>0?l*p(2,u-s)*(1+c/p(2,n)):0!==c?l*p(2,-(s-1))*(c/p(2,n)):l<0?-0:0}function I(e){return _(e,11,52)}function P(e){return O(e,11,52)}function j(e){return _(e,8,23)}function q(e){return O(e,8,23)}!function(){var t=function(e){if((e=i.ToInt32(e))<0)throw new RangeError("ArrayBuffer size is not a small enough positive integer")
var t
...
return n.find((function(n){return n!==e&&_n(n,t)}))?":nth-child("+(1+n.indexOf(e))+")":""}function zn(e){if(e.getAttribute("id")){var t=e.getRootNode&&e.getRootNode()||a,n="#"+Cn(e.getAttribute("id")||"")
...
do{var l=zn(e)
l||(l=Gn(e,i._selectorData),l+=Vn(e,l)),r=r?l+" > "+r:l,a=a?a.filter((function(e){return _n(e,r)})):Array.from(n.querySelectorAll(r)),e=e.parentElement}while((a.length>1||s)&&e&&11!==e.nodeType)
...
var t=e.match(/#!?\/?/g)
return t?"#"===O(t,1)[0]?"":e:""}var lo,uo=function(e,t){if(e.hasAttribute(t)){var n=e.nodeName.toUpperCase(),r=e;["A","AREA"].includes(n)&&!e.ownerSVGElement||((r=a.createElement("a")).href=e.getAttribute(t))
...
i=o._isXHTML?i:(i||"").toLowerCase(),_i().includes(i)||(i="text"),o._type=i}return tr.get("nodeMap")&&tr.get("nodeMap").set(e,N(o)),o}return j(r,[{key:"props",get:function(){if(!this._cache.hasOwnProperty("props")){var e=this.actualNode,t=e.nodeType,n=e.nodeName,r=e.id,a=e.multiple,o=e.nodeValue,i=e.value,s=e.selected
...
break}!r||!r.length||r instanceof n.Node?r instanceof n.Node&&(r.documentElement instanceof n.Node?i.push(e.flatTree[0]):i.push(nr(r))):r.length>1?So(e,t,r):(o=Array.from(a.querySelectorAll(r[0])),i=i.concat(o.map((function(e){return nr(e)}))))}return i.filter((function(e){return e}))}function _o(e,t){var r,i,s,l,u,c=this
...
if(s instanceof n.Document)return s.documentElement}return a.documentElement}(e)),this.exclude=e.exclude,this.include=e.include,this.include=Oo(this,"include"),this.exclude=Oo(this,"exclude"),Ni("frame, iframe",this).forEach((function(e){Go(e,c)&&function(e,t){Vo(t)||Pr(e.frames,"node",t)||e.frames.push(No(t,e))}(c,e.actualNode)})),void 0===this.page&&(this.page=1===(u=this.include).length&&u[0].actualNode===a.documentElement,this.frames.forEach((function(e){e.page=c.page})))
...
var i=null
"input"===(a=a.toLowerCase())&&(i=(e.type||e.attributes&&e.attributes.type||"").toLowerCase(),_i().includes(i)||(i="text"))
...
var o=(e.attr("role")||"").trim().toLowerCase(),i=n?Oi(o):[o],s=i.find((function(e){return!(!a&&"doc-"===e.substr(0,4))&&Wi(e,{allowAbstract:r})}))
...
if(!a){var u=!o&&!i
t=_({subtreeDescendant:u},t)}return Ns(e).reduce((function(e,n){return Rs(e,n,t)}),"")}
...
return Gr({elm:"label",attr:"for",value:e.attr("id"),context:e.actualNode})}var _s=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=sl.alreadyProcessed
if(t.inControlContext||t.inLabelledByContext||n(e,t))return""
t.startNode||(t.startNode=e)
var r,a=_({inControlContext:!0},t),o=Os(e),i=xr(e,"label")
...
return t.startNode||(t=_({startNode:e},t)),n?(1===n.nodeType&&t.inLabelledByContext&&void 0===t.includeHidden&&(t=_({includeHidden:!sa(n,!0)},t)),t):t}nl.alreadyProcessed=function(e,t){return t.processed=t.processed||[],!!t.processed.includes(e)||(t.processed.push(e),!1)}
...
if(i)for(var s=Oi(i),l=0;l<s.length;++l)t[s[l]]=t[s[l]]||[],t[s[l]].push(e)}}for(var u=0;u<e.childNodes.length;u++)1===e.childNodes[u].nodeType&&xl(e.childNodes[u],t,n)}var El=function(e){e=e.actualNode||e
var t=Wr(e)
...
o=o.parent}}return n}B(Yl,{getAriaRolesByType:function(){return Sl},getAriaRolesSupportingNameFromContent:function(){return _l},getElementSpec:function(){return vs},getElementsByContentType:function(){return Yi},getGlobalAriaAttrs:function(){return Ui},implicitHtmlRoles:function(){return ns}})
...
var o=Ou(r.getPropertyValue("width")),i=Ou(r.getPropertyValue("height"))
return"px"!==o.unit||"px"!==i.unit?0===o.value||0===i.value?0:1/0:o.value*i.value}))
function Ou(e){var t=O(e.match(/^([0-9.]+)([a-z]+)$/i)||[],3),n=t[1],r=void 0===n?"":n,a=t[2],o=void 0===a?"":a
return{value:parseFloat(r),unit:o.toLowerCase()}}function _u(e,t){var n=e.getRelativeLuminance(),r=t.getRelativeLuminance()
...
if(!r)return e
var o=r.map((function(e){return function(e,t){return _({},e,{ancestry:t.concat(e.ancestry)})}(e,a)})),i=function(e,t){for(;t.length;){var n=qu(e,t)
if(-1!==n)return n
t=Lu(t,1)}return-1}(e,a)
return-1===i?e.push.apply(e,S(o)):e.splice.apply(e,[i,0].concat(S(o))),e}function qu(e,t){return e.findIndex((function(e){return Yo(e.ancestry,t)}))}function Lu(e,t){return e.slice(0,e.length-t)}function Mu(e){var t=Cs(e),n=t&&t.includes("heading"),r=e.attr("aria-level"),a=parseInt(r,10),o=O(e.props.nodeName.match(/h(\d)/)||[],2)[1]
...
B(Hu,{aria:function(){return Hi},color:function(){return su},dom:function(){return Vr},forms:function(){return Uu},matches:function(){return gs},standards:function(){return Yl},table:function(){return Jl},text:function(){return cl},utils:function(){return Ot}})
var Uu={}
...
return!(n&&0!==n.length||"combobox"===Gi(t)&&Ei(t,'input:not([type="hidden"])').length)},sc={"abstractrole-evaluate":function(e,t,n){var r=Oi(n.attr("role")).filter((function(e){return"abstract"===Cl(e)}))
...
return!(null==a||!a.deprecated||(this.data(r),0))},"fallbackrole-evaluate":function(e,t,n){var r=Oi(n.attr("role"))
...
if(null===t)return!1
var n=Cl(t)
return"widget"===n||"composite"===n},"invalidrole-evaluate":function(e,t,n){var r=Oi(n.attr("role"))
...
this.data(o)
try{r=ba(_s(n)).toLowerCase(),a=ba(sl(n)).toLowerCase()}catch(e){return}return!(!a&&!r)&&!((a||!r)&&a.includes(r))&&void 0},"unsupportedrole-evaluate":function(e,t,n){return zi(Cs(n))},"valid-scrollable-semantics-evaluate":function(e,t){return function(e,t){var n=Gi(e)
...
var k=Tu(g,v),T=Tu(g,A),N=Tu(A,v);(E=Math.max(k,T,N))!==k&&(C=T>N?"shadowOnBgColor":"fgOnShadowColor")}var F=Math.ceil(72*w)/96,R=x&&F<l||!x&&F<u?c.normal:c.large,O=R.expected,_=R.minThreshold,I=R.maxThreshold,P=E>O
if("number"==typeof _&&E<_||"number"==typeof I&&E>I)return!0
var j,q=Math.floor(100*E)/100
null===g?j=Va.get("bgColor"):P||(j=C)
var L=1===q,M=1===f.length
return L?j=Va.set("bgColor","equalRatio"):P||!M||o||(j="shortTextContent"),this.data({fgColor:v?v.toHexString():void 0,bgColor:g?g.toHexString():void 0,contrastRatio:q,fontSize:"".concat((72*w/96).toFixed(1),"pt (").concat(w,"px)"),fontWeight:x?"bold":"normal",messageKey:j,expectedContrastRatio:O+":1",shadowColor:A?A.toHexString():void 0}),null===v||null===g||L||M&&!o&&!P?(j=null,Va.clear(),void this.relatedNodes(m)):(P||this.relatedNodes(m),P)}this.data({messageKey:"nonBmp"})},"link-in-text-block-evaluate":function(e){if(Pu(e))return!1
for(var t,n,r=Xr(e);1===r.nodeType&&!Pu(r);)r=Xr(r)
if(this.relatedNodes([r]),cu(e,r))return!0
if(t=Fu(e),n=Fu(r),t&&n){var a,o=_u(t,n)
return 1===o||(o>=3?(Va.set("fgColor","bgContrast"),this.data({messageKey:Va.get("fgColor")}),void Va.clear()):(t=Eu(e),n=Eu(r),(!t||!n||_u(t,n)>=3)&&(a=t&&n?"bgContrast":Va.get("bgColor"),Va.set("fgColor",a),this.data({messageKey:Va.get("fgColor")}),void Va.clear())))}},"autocomplete-appropriate-evaluate":function(e,t,n){if("input"!==n.props.nodeName)return!0
...
return c=_i().includes(c)?c:"text",void 0===u?"text"===c:u.includes(c)},"autocomplete-valid-evaluate":function(e,t,n){var r=n.attr("autocomplete")||""
...
if(m&&Vu(m))return!1}for(var g=[],v=t;v;){if(v.props.id){var y=El(v).filter((function(e){return Oi(e.getAttribute("aria-labelledby")||"").includes(v.props.id)})).map((function(e){return nr(e)}))
...
return!!(n&&Sl("widget").includes(n)&&_l().includes(n)&&(ba(Vi(t))||ba(ul(e)))&&ba(Ca(t)))},"label-matches":function(e,t){if("input"!==t.props.nodeName||!1===t.hasAttr("type"))return!0
...
var Tc=H(z()),Nc=H(Et()),Fc=H(xt()),Rc=H(Dt()),Sc=H(Ct()),Oc=H(At())
...
function jc(e){return Pc.hasOwnProperty(e)}function qc(e){return"string"==typeof e&&Pc[e]?Pc[e]:"function"==typeof e?e:_c}function Lc(e){var t=n&&"Node"in n&&"NodeList"in n,r=!!a
...
function Uc(e){this._run=e.run,this._collect=e.collect,this._registry={},e.commands.forEach((function(e){i._audit.registerCommand(e)}))}function $c(e){var t,r,s,l=O(e,3),u=l[0],c=l[1],d=l[2],p=new TypeError("axe.run arguments are invalid")
...
return _({},R(e,v),{relatedNodes:t.map((function(e){return e.toJSON()}))})}))}return n}function Qc(e){var t,n=[],r=q(e)
...
i.constants=Nt,i.log=Ft,i.AbstractVirtualNode=St,i.SerialVirtualNode=Bi,i.VirtualNode=fo,i._cache=tr,i._thisWillBeDeletedDoNotUse=i._thisWillBeDeletedDoNotUse||{},i._thisWillBeDeletedDoNotUse.base={Audit:Ac,CheckResult:uc,Check:fc,Context:_o,RuleResult:hc,Rule:vc,metadataFunctionMap:lc},i._thisWillBeDeletedDoNotUse.public={reporters:Pc},i.imports=kc,i.cleanup=Ic,i.configure=function(e){var t
...
return{ruleId:e.id,description:t.description,help:t.help,helpUrl:t.helpUrl,tags:e.tags}}))},i._load=function(e){i._audit=new Ac(e)},i.plugins={},i.registerPlugin=function(e){i.plugins[e.id]=new Uc(e)},i.hasReporter=jc,i.getReporter=qc,i.addReporter=function(e,t,n){Pc[e]=t,n&&(_c=t)},i.reset=function(){var e=i._audit
...
xi(o),yn(o)
var s=Dn([o])
return s.violations.forEach((function(e){return e.nodes.forEach((function(e){e.failureSummary=vo(e)}))})),_({},ko(),s,{toolOptions:n})},i.run=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
Lc(t[0])
...
var l=qr(e)
return(l=i._audit.after(l,a)).forEach(xi),Kc(l=l.map(yn),_({environmentData:s},a))},i.commons=Hu,i.utils=Ot,i.addReporter("na",(function(e,t,n){console.warn('"na" reporter will be deprecated in axe v4.0. Use the "v2" reporter instead.'),"function"==typeof t&&(n=t,t={})
var r=t,a=r.environmentData,o=R(r,y)
n(_({},ko(a),{toolOptions:o},wo(e,t)))})),i.addReporter("no-passes",(function(e,t,n){"function"==typeof t&&(n=t,t={})
var r=t,a=r.environmentData,o=R(r,b)
t.resultTypes=["violations"]
var i=wo(e,t).violations
n(_({},ko(a),{toolOptions:o,violations:i}))})),i.addReporter("rawEnv",(function(e,t,n){"function"==typeof t&&(n=t,t={})
...
if((o=d[3])&&n.getElementsByClassName&&t.getElementsByClassName)return _.apply(r,t.getElementsByClassName(o)),r}if(n.qsa&&!T[e+" "]&&(!g||!g.test(e))&&(1!==D||"object"!==t.nodeName.toLowerCase())){if(v=e,y=t,1===D&&(z.test(e)||V.test(e))){for((y=ee.test(e)&&ve(t.parentNode)||t)===t&&n.scope||((c=t.getAttribute("id"))?c=c.replace(re,ae):t.setAttribute("id",c=w)),s=(h=i(e)).length;s--;)h[s]=(c?"#"+c:":scope")+" "+be(h[s])
...
n[J.expando]=void 0}n[Z.expando]&&(n[Z.expando]=void 0)}}}),C.fn.extend({detach:function(e){return Me(this,e,!0)},remove:function(e){return Me(this,e)},text:function(e){return z(this,(function(e){return void 0===e?C.text(this):this.empty().each((function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)}))}),null,e,arguments.length)},append:function(){return Le(this,arguments,(function(e){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||_e(this,e).appendChild(e)}))},prepend:function(){return Le(this,arguments,(function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=_e(this,e)
...
break}return n}function R(e,t){return-1!==t.indexOf(e)}function S(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=t&&P("array",e)?[]:{}
for(var r in e)if(A.call(e,r)){var a=e[r]
n[r]=a===Object(a)?S(a,t):a}return n}function O(e,t){if(e!==Object(e))return e
var n={}
for(var r in t)A.call(t,r)&&A.call(e,r)&&(n[r]=O(e[r],t[r]))
return n}function _(e,t,n){for(var r in t)A.call(t,r)&&(void 0===t[r]?delete e[r]:n&&void 0!==e[r]||(e[r]=t[r]))
...
return e.length=0,t}}(),M={queue:[],stats:{all:0,bad:0,testCount:0},blocking:!0,failOnZeroTests:!0,reorder:!0,altertitle:!0,collapse:!0,scrolltop:!0,maxDepth:5,requireExpects:!1,urlConfig:[],modules:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},globalHooks:{},callbacks:{},storage:x},B=m&&m.QUnit&&m.QUnit.config
m&&m.QUnit&&!m.QUnit.version&&_(M,B),M.modules.push(M.currentModule)
...
return t=null===e?"null":void 0===e?"undefined":P("regexp",e)?"regexp":P("date",e)?"date":P("function",e)?"function":void 0!==e.setInterval&&void 0!==e.document&&void 0===e.nodeType?"window":9===e.nodeType?"document":e.nodeType?"node":function(e){return"[object Array]"===C.call(e)||"number"==typeof e.length&&void 0!==e.item&&(e.length?e.item(0)===e[0]:null===e.item(0)&&void 0===e[0])}(e)?"array":e.constructor===Error.prototype.constructor?"error":i(e),t},separator:function(){return this.multiline?this.HTML?"<br />":"\n":this.HTML?"&#160;":" "},indent:function(e){if(!this.multiline)return""
...
r&&_(l,r.testEnvironment),_(l,t)
var u={name:a,parentModule:r,hooks:{before:[],beforeEach:[],afterEach:[],after:[]},testEnvironment:l,tests:[],moduleId:j(a),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new U(e,o),stats:null,skip:i,todo:!i&&s,ignored:n.ignored||!1}
return r&&r.childModules.push(u),M.modules.push(u),u}function W(e,t,n){var r=t[n]
"function"==typeof r&&e[n].push(r),delete t[n]}function G(e,t){return function(n){M.currentModule!==e&&E.warn("The `"+t+"` hook was called inside the wrong module (`"+M.currentModule.name+"`). Instead, use hooks provided by the callback to the containing module (`"+e.name+"`). This will become an error in QUnit 3.0."),e.hooks[t].push(n)}}function Y(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
...
var s={before:G(a,"before"),beforeEach:G(a,"beforeEach"),afterEach:G(a,"afterEach"),after:G(a,"after")},l=M.currentModule
if(M.currentModule=a,"function"===I(n)){$.push(a)
try{var u=n.call(a.testEnvironment,s)
null!=u&&"function"===I(u.then)&&E.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{$.pop(),M.currentModule=a.parentModule||l}}}var Q=!1
function X(e,t,n){var r,a=Q&&(r=M.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!$.some((function(e){return r.includes(e.moduleId)})))
Y(e,t,n,{ignored:a})}X.only=function(){Q||(M.modules.length=0,M.queue.length=0,M.currentModule.ignored=!0),Q=!0,Y.apply(void 0,arguments)},X.skip=function(e,t,n){Q||Y(e,t,n,{skip:!0})},X.todo=function(e,t,n){Q||Y(e,t,n,{todo:!0})}
var K=Object.create(null),J=["error","runStart","suiteStart","testStart","assertion","testEnd","suiteEnd","runEnd"]
function Z(e,t){if("string"!==I(e))throw new TypeError("eventName must be a string when emitting an event")
for(var n=K[e],r=n?d(n):[],a=0;a<r.length;a++)r[a](t)}var ee="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},te={exports:{}}
...
n=!0,l(t,e)}}}()
var ne=te.exports
function re(e,t){var n=M.callbacks[e]
...
function ce(){var e,t
e=k(),M.depth=(M.depth||0)+1,de(e),M.depth--,ue.length||M.blocking||M.current||(M.blocking||M.queue.length||0!==M.depth?(t=M.queue.shift()(),ue.push.apply(ue,d(t)),le>0&&le--,ce()):function(){var e
if(0===M.stats.testCount&&!0===M.failOnZeroTests)return e=M.filter&&M.filter.length?new Error('No tests matched the filter "'.concat(M.filter,'".')):M.module&&M.module.length?new Error('No tests matched the module "'.concat(M.module,'".')):M.moduleId&&M.moduleId.length?new Error('No tests matched the moduleId "'.concat(M.moduleId,'".')):M.testId&&M.testId.length?new Error('No tests matched the testId "'.concat(M.testId,'".')):new Error("No tests were run."),we("global failure",_((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void ce()
var t=M.storage,n=k()-M.started,r=M.stats.all-M.stats.bad
pe.finished=!0,Z("runEnd",V.end(!0)),re("done",{passed:r,failed:M.stats.bad,total:M.stats.all,runtime:n}).then((function(){if(t&&0===M.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}function de(e){if(ue.length&&!M.blocking){var t=k()-e
if(!y||M.updateRate<=0||t<M.updateRate){var n=ue.shift()
ne.resolve(n()).then((function(){ue.length?de(e):ce()}))}else y(ce)}}var pe={finished:!1,add:function(e,t,n){if(t)M.queue.splice(le++,0,e)
...
M.queue.splice(le+r,0,e)}else M.queue.push(e)},advance:ce,taskCount:function(){return ue.length}},fe=function(){function e(t,n,r){s(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return u(e,[{key:"start",value:function(e){return e&&(this._startTime=N.now(),N.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=N.now(),N)){N.mark("qunit_test_end")
...
this.testId=j(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new Fe(this)}}function me(){if(!M.current)throw new Error("pushFailure() assertion outside test context, in "+ie(2))
var e=M.current
return e.pushFailure.apply(e,arguments)}function ge(){if(M.pollution=[],M.noglobals)for(var e in h)if(A.call(h,e)){if(/^qunit-test-output/.test(e))continue
M.pollution.push(e)}}he.count=0,he.prototype={get stack(){return oe(this.errorForStack,2)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t)
return n.reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:k()},Z("suiteStart",t.suiteReport.start(!0)),re("moduleStart",{name:t.name,tests:t.tests})}))}),ne.resolve([])).then((function(){return M.current=e,e.testEnvironment=_({},t.testEnvironment),e.started=k(),Z("testStart",e.testReport.start(!0)),re("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){M.pollution||ge()}))}))},run:function(){if(M.current=this,this.callbackStarted=k(),M.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+" "+this.stack+": "+(e.message||e),oe(e,0)),ge(),M.blocking&&Ce(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&me("Test did not finish synchronously even though assert.timeout( 0 ) was used.",ie(2))}},after:function(){!function(){var e=M.pollution
ge()
var t=F(M.pollution,e)
t.length>0&&me("Introduced global variable(s): "+t.join(", "))
var n=F(e,M.pollution)
...
r.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===ke(e).filter((function(e){return!e.skip})).length-1}(n)||!(M.queue.length>0||pe.taskCount()>2))if(M.current=r,M.notrycatch)a()
...
if(A.call(e,"expected")&&(r.expected=e.expected),!e.result){var a=e.source||ie()
...
n.pushFailure(r,oe(e,0)),ge(),Ce(n)}))}}},valid:function(){var e=M.filter,t=/^(!?)\/([\w\W]*)\/(i?$)/.exec(e),n=M.module&&M.module.toLowerCase(),r=this.module.name+": "+this.testName
return!(!this.callback||!this.callback.validTest)||!(M.moduleId&&M.moduleId.length>0&&!function e(t){return R(t.moduleId,M.moduleId)||t.parentModule&&e(t.parentModule)}(this.module))&&!(M.testId&&M.testId.length>0&&!R(this.testId,M.testId))&&!(n&&!function e(t){return(t.name?t.name.toLowerCase():null)===n||!!t.parentModule&&e(t.parentModule)}(this.module))&&(!e||(t?this.regexFilter(!!t[1],t[2],t[3],r):this.stringFilter(e,r)))},regexFilter:function(e,t,n,r){return new RegExp(t,n).test(r)!==e},stringFilter:function(e,t){e=e.toLowerCase(),t=t.toLowerCase()
var n="!"!==e.charAt(0)
return n||(e=e.slice(1)),-1!==t.indexOf(e)?n:!n}}
var ve=!1
function ye(e){ve||M.currentModule.ignored||new he(e).queue()}function be(e){M.currentModule.ignored||(ve||(M.queue.length=0,ve=!0),new he(e).queue())}function we(e,t){ye({testName:e,callback:t})}function De(e,t){return"".concat(e," [").concat(t,"]")}function xe(e,t){if(Array.isArray(e))e.forEach(t)
...
a.remaining--,0===a.remaining&&e.pauses.delete(r),Ae(e)}}return e.pauses.set(r,a),y&&("number"==typeof e.timeout?n=e.timeout:"number"==typeof M.testTimeout&&(n=M.testTimeout),"number"==typeof n&&n>0&&(M.timeoutHandler=function(t){return function(){M.timeout=null,a.cancelled=!0,e.pauses.delete(r),e.pushFailure("Test took longer than ".concat(t,"ms; test timed out."),ie(2)),Ae(e)}},b(M.timeout),M.timeout=y(M.timeoutHandler(n),n))),o}function Ce(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Ae(e)}function Ae(e){e.pauses.size>0||(y?(b(M.timeout),M.timeout=y((function(){e.pauses.size>0||(b(M.timeout),M.timeout=null,tt())}))):tt())}function ke(e){for(var t=[].concat(e.tests),n=d(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,d(r.childModules))}return t}function Te(e){return e.testsRun+e.testsIgnored===ke(e).length}function Ne(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}_(we,{todo:function(e,t){ye({testName:e,callback:t,todo:!0})},skip:function(e){ye({testName:e,skip:!0})},only:function(e,t){be({testName:e,callback:t})},each:function(e,t,n){xe(t,(function(t,r){ye({testName:De(e,r),callback:n,withData:!0,data:t})}))}}),we.todo.each=function(e,t,n){xe(t,(function(t,r){ye({testName:De(e,r),callback:n,todo:!0,withData:!0,data:t})}))},we.skip.each=function(e,t){xe(t,(function(t,n){ye({testName:De(e,n),skip:!0})}))},we.only.each=function(e,t,n){xe(t,(function(t,r){be({testName:De(e,r),callback:n,withData:!0,data:t})}))}
...
var t
this.test.timeout=e,M.timeout&&(b(M.timeout),M.timeout=null,M.timeoutHandler&&this.test.timeout>0&&(t=this.test.timeout,b(M.timeout),M.timeout=y(M.timeoutHandler(t),t)))}},{key:"step",value:function(e){var t=e,n=!!e
...
this.pushResult({result:r,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=S(e),t=S(t),this.pushResult({result:L(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=S(e),t=S(t),this.pushResult({result:!L(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"propContains",value:function(e,t,n){e=O(e,t),t=S(t,!1),this.pushResult({result:L(e,t),actual:e,expected:t,message:n})}},{key:"notPropContains",value:function(e,t,n){e=O(e,t),t=S(t),this.pushResult({result:!L(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:L(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!L(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var a=c(Re(n,r,"throws"),2)
n=a[0],r=a[1]
var o=this instanceof e&&this.test||M.current
if("function"===I(t)){var i,s=!1
o.ignoreGlobalErrors=!0
try{t.call(o.testEnvironment)}catch(e){i=e}if(o.ignoreGlobalErrors=!1,i){var l=c(Se(i,n,r),3)
...
o.assert.pushResult({result:!1,message:e,actual:t}),s()}),(function(e){var t,a=c(Se(e,n,r),3)
...
return[e,t]}function Se(e,t,n){var r=!1,a=I(t)
...
var Oe,_e,Ie,Pe,je=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
Oe=Le.FORCE_COLOR,_e=Le.NODE_DISABLE_COLORS,Ie=Le.NO_COLOR,Pe=Le.TERM,qe=process.stdout&&process.stdout.isTTY}var Me={enabled:!_e&&null==Ie&&"dumb"!==Pe&&(null!=Oe&&"0"!==Oe||qe),reset:He(0,0),bold:He(1,22),dim:He(2,22),italic:He(3,23),underline:He(4,24),inverse:He(7,27),hidden:He(8,28),strikethrough:He(9,29),black:He(30,39),red:He(31,39),green:He(32,39),yellow:He(33,39),blue:He(34,39),magenta:He(35,39),cyan:He(36,39),white:He(37,39),gray:He(90,39),grey:He(90,39),bgBlack:He(40,49),bgRed:He(41,49),bgGreen:He(42,49),bgYellow:He(43,49),bgBlue:He(44,49),bgMagenta:He(45,49),bgCyan:He(46,49),bgWhite:He(47,49)}
...
t+="\n  message: ".concat($e(q(e))),t+="\n  severity: ".concat($e("failed")),e&&e.stack&&(t+="\n  stack: ".concat($e(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),We={console:je,tap:ze}
function Ge(e){return function(t){M.globalHooks[e]||(M.globalHooks[e]=[]),M.globalHooks[e].push(t)}}var Ye={beforeEach:Ge("beforeEach"),afterEach:Ge("afterEach")}
function Qe(e){M.current?M.current.assert.pushResult({result:!1,message:"global failure: ".concat(q(e)),source:e&&e.stack||ie(2)}):(V.globalFailureCount++,M.stats.bad++,M.stats.all++,Z("error",e))}var Xe={}
M.currentModule.suiteReport=V
var Ke=!1,Je=!1
function Ze(){Je=!0,y?y((function(){tt()})):tt()}function et(){M.blocking=!1,pe.advance()}function tt(){if(M.started)et()
...
Z("runStart",V.start(!0)),re("begin",{totalTests:he.count,modules:t}).then(et)}}Xe.isLocal=m&&m.location&&"file:"===m.location.protocol,Xe.version="2.18.0",_(Xe,{config:M,dump:H,equiv:L,reporters:We,hooks:Ye,is:P,objectType:I,on:function(e,t){if("string"!==I(e))throw new TypeError("eventName must be a string when registering a listener")
...
K[e]||(K[e]=[]),R(t,K[e])||K[e].push(t)},onError:function(e){if(E.warn("QUnit.onError is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),M.current&&M.current.ignoreGlobalErrors)return!0
var t=new Error(e.message)
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,Qe(t),!1},onUncaughtException:Qe,pushFailure:me,assert:Fe.prototype,module:X,test:we,todo:we.todo,skip:we.skip,only:we.only,start:function(e){if(M.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=Ke
if(Ke=!0,Je)throw new Error("Called start() while test already started running")
...
if(!M.pageLoaded)return M.autostart=!0,void(w||Xe.load())
...
return _.apply(this,t)},load:function(){M.pageLoaded=!0,_(M,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Je||(M.blocking=!1,M.autostart&&Ze())},stack:function(e){return ie(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===I(M.callbacks[o])&&(M.callbacks[o]=[]),e[o]=n(o)}}(Xe),function(a){var o=!1
if(m&&w){if(m.QUnit&&m.QUnit.version)throw new Error("QUnit has already been defined.")
m.QUnit=a,o=!0}e&&e.exports&&(e.exports=a,e.exports.QUnit=a,o=!0),t&&(t.QUnit=a,o=!0),void 0===(r=function(){return a}.call(t,n,t,e))||(e.exports=r),a.config.autostart=!1,o=!0,g&&g.WorkerGlobalScope&&g instanceof g.WorkerGlobalScope&&(g.QUnit=a,o=!0),o||(h.QUnit=a)}(Xe),function(){if(m&&w){var e=Xe.config,t=Object.prototype.hasOwnProperty
Xe.begin((function(){if(!t.call(e,"fixture")){var n=w.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),Xe.testStart((function(){if(null!=e.fixture){var t=w.getElementById("qunit-fixture")
...
i&&v.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),i||"complete"!==w.readyState?u(m,"load",Xe.load):Xe.load()
var s=m.onerror
...
for(t in e=_(_({},Xe.urlParams),e))if(r.call(e,t)&&void 0!==e[t])for(n=[].concat(e[t]),a=0;a<n.length;a++)o+=encodeURIComponent(t),!0!==n[a]&&(o+="="+encodeURIComponent(n[a])),o+="&"
...
if(s)return(r=w.createElement("strong")).innerHTML=R(e,n),(o=w.createElement("li")).appendChild(r),void 0!==t&&((a=w.createElement("a")).innerHTML="Rerun",a.href=A({testId:t}),o.id="qunit-test-output-"+t,o.appendChild(a)),(i=w.createElement("ol")).className="qunit-assert-list",o.appendChild(i),s.appendChild(o),o}function F(e){return 0===e.length?"":["<br /><a href='"+ot(A({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function R(e,t){var n=""
return t&&(n="<span class='module-name'>"+ot(t)+"</span>: "),n+"<span class='test-name'>"+ot(e)+"</span>"}function S(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function O(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Xe.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
//# sourceMappingURL=chunk.535.de0747320fc09548a67d.map